...
[![npm](https://img.shields.io/npm/v/prettier-plugin-cljfmt.svg)](https://www.npmjs.com/package/prettier-plugin-cljfmt)
...
If a `.cljfmt.edn` file exists in the file's directory or any ancestor, it is picked up automatically. Otherwise, cljfmt defaults are used. See [cljfmt's configuration docs](https://github.com/weavejester/cljfmt#configuration) for available keys.
